  ...
  *                                                                           *
  *****************************************************************************
  * $Id: deleteWallMessage.java,v 1.4 2011/03/18 14:47:15 manish Exp $
  *****************************************************************************
  */
...
/**
 * Method:  deleteWallMessage
 * Deletes message from playdate's wall
 *
 * Required Parameters:
 ...
 *
 *  See Also:
 *      <getWallMessages>, <postWallMessage>
 *
 */

public class

deleteWallMessage extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, 
      ...
      deleteWallMessageForm deleteWallMessageForm=null;
      ...
      try {
           ...
           deleteWallMessageForm=(deleteWallMessageForm)form;
          ...
          rc = Operations.deleteWallMessage(deleteWallMessageForm,Integer.parseInt(userTblPk),ds);  
          ...
          if (rc < 0) {
              ...
              jsonStatus.put(messageResources.getMessage("json.response.methodname.displayname"),messageResources.getMessage("json.response.methodname.deletewallmessage"));
              
              if (rc == -1) {
                  jsonResponse.put(messageResources.getMessage("json.response.reasoncode.displayname"),messageResources.getMessage("json.response.methodname.deletewallmessage.message.failure.reasoncode.1"));
                  jsonResponse.put(messageResources.getMessage("json.response.reasonstr.displayname"),messageResources.getMessage("json.response.methodname.deletewallmessage.message.failure.reasonstr.1"));
              }
              else if (rc == -2) {
