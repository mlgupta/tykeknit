  ...
  *                                                                           *
  *****************************************************************************
  * $Id: deleteAccount.java,v 1.4 2011/03/18 14:47:15 manish Exp $
  *****************************************************************************
  */
package com.tykeknit.web.api.actions;

import com.tykeknit.web.api.actionforms.deleteAccountForm;
 ...
 * Deletes Users account from the system. This method does not physically deletes the account, but rather sets inactive date of the account to current date.
 *
 * Required Parameters:
 *  None
 *
 ...
 *
 *  See Also:
 *      <register>, <LoginAction>, <logout>
 *
 */

public class

deleteAccount extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, 
      ...
      deleteAccountForm deleteAccountForm=null;
      ...
      try {
          ...
          deleteAccountForm=(deleteAccountForm)form;
          ...
          rc = Operations.deleteAccount(Integer.parseInt(userTblPk),ds);
          ...
          if (rc < 0) {
              ...
              jsonStatus.put(messageResources.getMessage("json.response.methodname.displayname"),messageResources.getMessage("json.response.methodname.deleteAccount"));
