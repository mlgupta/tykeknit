  ...
  *                                                                           *
  *****************************************************************************
  * $Id: setFBIdToken.java,v 1.5 2011/04/01 07:02:57 manish Exp $
  *****************************************************************************
  */
...
/**
 * Method:  setFBIdToken
 *  Sets Facebook Userid and Token in the system for a user
 *
 * Required Parameters:
 *  txtFBId            - Facebook ID of user
 *  txtFBAuthToken     - Facebook Auth Token
 *
 * Optional Parameters:
 *  None
 *
...
setFBIdToken extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, 
      ...
      setFBIdTokenForm setFBIdTokenForm=null;
      ...
      try {
           ...
           setFBIdTokenForm=(setFBIdTokenForm)form;
          ...
          rc = Operations.setFBIdToken(userTblPk, setFBIdTokenForm,  ds);
          ...
          if (rc < 0) {
             ...
             jsonStatus.put(messageResources.getMessage("json.response.methodname.displayname"),messageResources.getMessage("json.response.methodname.setFBIdToken"));
