  ...
  *                                                                           *
  *****************************************************************************
  * $Id: deleteEventWallMessage.java,v 1.1 2011/07/01 12:57:08 manish Exp $
  *****************************************************************************
  */
...
/**
 * Method:  deleteEventWallMessage
 * Deletes message from Event TykeBoard
 *
 * Required Parameters:
 ...
 * Returns:
 * (start code)
 *  { "methodName" : "deleteEventWallMessage",
 *    "response" : "",
 ...
 *
 *  See Also:
 *      <getEventWallMessages>, <postEventWallMessage>
 *
 */

public class

deleteEventWallMessage extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, 
      ...
      deleteEventWallMessageForm deleteEventWallMessageForm=null;
      ...
      try {
           ...
           deleteEventWallMessageForm=(deleteEventWallMessageForm)form;
          ...
          rc = Operations.deleteEventWallMessage(deleteEventWallMessageForm,Integer.parseInt(userTblPk),ds);  
          ...
          if (rc < 0) {
              ...
              jsonStatus.put(messageResources.getMessage("json.response.methodname.displayname"),messageResources.getMessage("json.response.methodname.deleteEventWallMessage"));
              
              if (rc == -1) {
                  jsonResponse.put(messageResources.getMessage("json.response.reasoncode.displayname"),messageResources.getMessage("json.response.methodname.deleteEventWallMessage.message.failure.reasoncode.1"));
                  jsonResponse.put(messageResources.getMessage("json.response.reasonstr.displayname"),messageResources.getMessage("json.response.methodname.deleteEventWallMessage.message.failure.reasonstr.1"));
              }
              else if (rc == -2) {
