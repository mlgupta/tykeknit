  ...
  *                                                                           *
  *****************************************************************************
  * $Id: deleteUserPic.java,v 1.1 2011/04/29 15:15:39 manish Exp $
  *****************************************************************************
  */
package com.tykeknit.web.api.actions;

import com.tykeknit.web.api.actionforms.deleteUserPicForm;
...
/**
 * Method:  deleteUserPic
 * Deletes Users picture from the system. After this picture is deleted client should use default picture.
 *
 * Required Parameters:
 *  None
 *
...
deleteUserPic extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, 
      ...
      deleteUserPicForm deleteUserPicForm=null;
      ...
      try {
          ...
          deleteUserPicForm=(deleteUserPicForm)form;
          ...
          rc = Operations.deleteUserPic(Integer.parseInt(userTblPk),ds);
          ...
          if (rc < 0) {
              ...
              jsonStatus.put(messageResources.getMessage("json.response.methodname.displayname"),messageResources.getMessage("json.response.methodname.deleteUserPic"));
