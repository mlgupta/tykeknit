  ...
  *                                                                           *
  *****************************************************************************
  * $Id: updateMessageReadStatus.java,v 1.2 2011/06/19 16:27:40 manish Exp $
  *****************************************************************************
  */
package com.tykeknit.web.api.actions;

import com.tykeknit.web.api.actionforms.updateMessageReadStatusForm;
...
/**
 * Method:  updateMessageReadStatus
 * Marks message as read
 *
 * Required Parameters:
 *  txtMessageId    - Message ID
 *  txtReadStatus   - Message Read Status (N- Not Read, R-Read)
 *
 * Optional Parameters:
 *  None
 *
...
updateMessageReadStatus extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, 
      ...
      updateMessageReadStatusForm updateMessageReadStatusForm=null;
      ...
      try {
           ...
           updateMessageReadStatusForm=(updateMessageReadStatusForm)form;
          ...
          rc = Operations.updateMessageReadStatus(Integer.parseInt(updateMessageReadStatusForm.getTxtMessageId()),Integer.parseInt(userTblPk),updateMessageReadStatusForm.getTxtReadStatus(),ds);  
          ...
          if (rc < 0) {
              ...
              jsonStatus.put(messageResources.getMessage("json.response.methodname.displayname"),messageResources.getMessage("json.response.methodname.updateMessageReadStatus"));
              
              if (rc == -1) {
                  jsonResponse.put(messageResources.getMessage("json.response.reasoncode.displayname"),messageResources.getMessage("json.response.methodname.updateMessageReadStatus.message.failure.reasoncode.1"));
                  jsonResponse.put(messageResources.getMessage("json.response.reasonstr.displayname"),messageResources.getMessage("json.response.methodname.updateMessageReadStatus.message.failure.reasonstr.1"));
              }
              else if (rc == -2) {
